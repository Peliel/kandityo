...
\keywords{Valitse avainsanoiksi opinnäytteen keskeistä sisältöä kuvaavia sanoja.
Avainsanat kirjoitetaan pienellä, erisnimiä ja vakiintuneita lyhenteitä 
lukuunottamatta. Esim. vastus\spc resistanssi\spc lämpötila}
%% Abstract text
\begin{abstractpage}[finnish]
  Jätä kappaleiden väliin yksi tyhjä rivi. Älä tavuta tai muotoile tekstiä.\\

  \noindent
  Tiivistelmä on lyhyt kuvaus työn keskeisestä sisällöstä:
  mitä tutkittiin ja miten sekä mitkä olivat tärkeimmät tulokset?\\

  \noindent
  Suomenkielisen opinnäytetyön tiivistelmä on kirjoitettava sekä suomeksi että 
  englanniksi; ruotsinkieliseen tutkielmaan ruotsiksi ja englanniksi. 
  Suomenkielisten tai ruotsinkielisten kirjoittamien englanninkielisten
  opinnäytetteiden tiivistelmät on kirjoitettava englanniksi ja joko suomeksi 
  tai ruotsiksi opiskelijan perusopetuksen kielestä riippuen. Muilla kielillä 
  kuin suomen tai ruotsin kielellä koulutetut opiskelijat kirjoittavat 
  tiivistelmän vain englanniksi. Opiskelija voi halutessaan sisällyttää toisen 
  tai kolmannen abstraktin äidinkielellään.\\

  \noindent
  Tämän opinnäytteen tiivistelmäteksti kirjoitetaan opinnäytteen luettavan osan
  lomakkeen lisäksi myös pdf-tiedoston metatietoon
  \verb+\thesisabstract\verb+-makron avulla (katso kommenti yllä tässa 
  \TeX{}-tiedostossa). Metatietotekstissa ei saa olla erikoismerkkejä, 
  rivinvaiho- tai kappaleenjakomerkkiä. Kirjoita tähän tiivitelmäsivulle menevä 
  tiivistelmäteksti. Tässä tekstissä saa olla erikoismerkkejä, rivinvaiho- tai 
  kappaleenjakomerkkiä.\\

  \noindent
  Jos tiivistelmäsi ei sisällä erikoimerkkejä eikä kaipaa kappaleenjakoa, voit 
  hyödynttää makroa \verb+\abstracttext\verb+ luodessasi lomakkeen tiivistelmää 
  (kasto kommentti yllä). Metatietotiivistelmatekstin on muuten oltava sama kuin 
  tiivistelmäsivulla oleva teksti.
\end{abstractpage}
...
\input{chapters/03_research_material_and_methods.tex}
...
\begin{figure}[b]
	\centering
		\includegraphics[height=31mm]{./images/linediagram.pdf}
