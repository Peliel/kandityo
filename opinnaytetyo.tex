...
\newtheorem{asetus}[definition]{Asetus}
...
\input{sections/2-monistot.tex}
\input{sections/2a-topologia.tex}
\input{sections/3-solmuteoriaa.tex}
\input{sections/4-pujoskaaviot.tex}
\input{sections/5-dehn-kirurgia.tex}
\input{sections/6-rpi-kaaviot.tex}
\input{sections/7-yhteenveto.tex}
