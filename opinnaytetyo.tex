...
%%
\supervisor{Prof.\ {\color{red}Oscar Kivinen}}
%%
...
\advisor{TkT {\color{red}OHJAAJAN NIMI}}
...
\supervisor{Prof.\ {\color{red}Oscar Kivinen}}
\advisor{DSc\ (Tech.) {\color{red}OHJAAJAN NIMI}}
...
\input{sections/2-aikaisempitutkimus}
\input{sections/3-menetelmat}
\input{sections/4-tulokset}
\input{sections/5-yhteenveto}
