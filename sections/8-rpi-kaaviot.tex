...
\begin{proof}[Lausen \ref{lause:päätulos}(i) todistus]
    ...
    Tällöin $\linkki_0=(R,(\P^1\cup C)\cap R)$ on linkki, jota voidaan esittää pujoskaaviolla~\ref{kuva:pujoskaavio-todistukseen}.
    \begin{pujoskaavio}[h!]
        \centering
        \includegraphics[width=0.25\textwidth]{figures/pujoskaavio-todistuksessa.pdf}
        \caption{}
        \label{kuva:pujoskaavio-todistukseen}
    \end{pujoskaavio}
